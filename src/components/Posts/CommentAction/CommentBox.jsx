...
const CommentBox = () => {
    ...
    const setOnchangeComment = async (e) => {
        setTimeout(() => {
    ...
    return (
        <div className='grid items-start grid-cols-1 gap-3 sm:grid-cols-12'>
            ...
            <div className='sm:col-span-11 relative bg-[#F0F2F5] dark:bg-[#3A3B3C] rounded-2xl'>
                <form>
                    {/* Comment TextBox */}
                    <input value={comment} onChange={setOnchangeComment} id='comment' className='w-full pr-[4.5rem] focus:outline focus:outline-offset-2 focus:outline-blue-500 bg-transparent rounded-2xl px-3 py-2 outline-none dark:text-[#E4E6EB] text-[#050505]' type="text" placeholder='Write a comments...' />
