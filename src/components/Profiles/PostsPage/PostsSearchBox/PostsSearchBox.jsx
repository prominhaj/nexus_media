    ...
    return (
        <div>
            <div className='bg-white dark:bg-[#293145] rounded-md shadow-lg p-3 flex items-center gap-3 md:gap-5'>
                ...
                <div className='flex items-center flex-1 rounded shadow dark:bg-dark-bg'>
                    <span className='px-2'>
                        <IoSearch className='text-xl' />
                    </span>
                    <input
                        className=' px-3 py-[0.375rem] text-base w-full outline-none dark:bg-transparent text-light-text dark:text-dark-text bg-light-bg'
                        type='search'
