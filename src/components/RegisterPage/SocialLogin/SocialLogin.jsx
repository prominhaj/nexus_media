    ...
    return (
        <>
            ...
            <div className='grid gap-3 py-3 md:grid-cols-2'>
                {/* Google */}
                <Button disabled={googleLoading} className='!cursor-pointer' onClick={handleGoogleLogin} color="gray" variant="solid" highContrast>
                    {googleLoading && <Spinner loading />}
                ...
                {/* Github */}
                <Button disabled={githubLoading} className='!cursor-pointer' onClick={handleGithubLogin} color="gray" variant="solid" highContrast>
                    {githubLoading && <Spinner loading />}
