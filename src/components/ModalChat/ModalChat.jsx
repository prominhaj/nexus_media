...
const ModalChat = ({ modal, setModal }) => {
    ...
    return (
        <>
            <div className={`${modal ? "block" : "hidden"} fixed flex items-center justify-center duration-300 z-50 transition-all bottom-5 w-80 right-[15%] bg-white dark:bg-black rounded-lg shadow-xl dark:shadow-gray-700`}>
                <div>
